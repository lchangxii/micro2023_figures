...
def process_sheet_name(sheet_name,benchname,x_loc,y_loc):
    ...
    atomic_regions = [ (sheet_name,'walltime'), (sheet_name,'pkawalltime'),(sheet_name,'mixwalltime')]

    atomic_regions_name =  ['Full',"PKA","Photon"]
    dicts = []
    ...
    atomic_regions = [ (sheet_name,'simtime'),(sheet_name,'pkasimtime'), (sheet_name,'mixsimtime')]
    for sheetname,columnname in atomic_regions:
        no_flowff_value_dict,benchmarks = get_data(file_name,  sheetname,columnname)
    ...
    hatchcolors = ['#20416b','#fdae61', '#a32a30']
